package org.wxm.summary.security.view;

import java.util.Map;
import java.util.Set;

import org.wxm.summary.system.bean.SysUser;
...
public class UserDetail extends SysUser {
     ...
     * 权限信息
     */
    private Map<String, Set<String>> menuOperates; // 菜单-操作
    ...
    public Map<String, Set<String>> getMenuOperates() {
        return menuOperates;
    }

    public void setMenuOperates(Map<String, Set<String>> menuOperates) {
